...
export default async function SignInPage ({
  ...
  // Added message from URL query parameter (for redirects with messages)
  ...
  async function signInAction (formData: FormData): Promise<FormState> {
    ...
    try {
      ...
      await auth.api.signInEmail({
        ...
        options: {
          // Added remember option from checkbox
          sessionAge: remember ? 30 * 24 * 60 * 60 : undefined // 30 days if remembered
        }
      })
